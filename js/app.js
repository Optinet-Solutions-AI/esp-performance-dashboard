    ...
    const esps = [
      ...
      { name: 'MMS',          color: '#7c5cfc', sent: 0, delivered: 0, opens: 0, clicks: 0, bounced: 0, unsub: 0 },
      { name: 'Kenscio',      color: '#ffd166', sent: 0, delivered: 0, opens: 0, clicks: 0, bounced: 0, unsub: 0 },
      { name: 'Moosend',      color: '#00b8d9', sent: 0, delivered: 0, opens: 0, clicks: 0, bounced: 0, unsub: 0 },
      { name: 'Mailmodo',     color: '#ff6b35', sent: 0, delivered: 0, opens: 0, clicks: 0, bounced: 0, unsub: 0 },
      { name: 'Netcore',      color: '#ff4757', sent: 0, delivered: 0, opens: 0, clicks: 0, bounced: 0, unsub: 0 },
      { name: 'Bulkresponse', color: '#a8e6cf', sent: 0, delivered: 0, opens: 0, clicks: 0, bounced: 0, unsub: 0 },
...
<div class="mm-tip-calc">${calcText}</div>`;
  ...
  <div class="dp-cal-grid">`;
    ...
    // One-time migration: clear old data if version doesn't match
    if (localStorage.getItem('espDashboard_dataVersion') !== DATA_VERSION) {
      localStorage.removeItem(STORAGE_KEY);
      localStorage.removeItem(HISTORY_KEY);
      localStorage.removeItem('espDashboard_dmData_v1');
      localStorage.removeItem('espDashboard_ipmData_v1');
      localStorage.setItem('espDashboard_dataVersion', DATA_VERSION);
    }
